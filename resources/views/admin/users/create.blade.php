...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data" autocomplete="off" class="row">
            @csrf
            ...
            <div class="organization form-group {{ $errors->has('organization') ? 'has-error' : '' }} col-md-6">
            ...
            <div class="organization_domain form-group {{ $errors->has('organization_domain') ? 'has-error' : '' }} col-md-6">
