...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.refdatafield.update", [$data['_id']]) }}" method="POST" enctype="multipart/form-data" class="row">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('field_type') ? 'has-error' : '' }} col-md-6">
